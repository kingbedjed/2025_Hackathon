import numpy as np
from generate_synthetic_training_data_TP_doubleTwin import generate_stem_image_with_continuous_gb, rotate_flip_image_and_bboxes, yolo_format_bounding_boxes
from pathlib import Path
from PIL import Image
from tqdm import tqdm

training_data_dir = Path("./data/dataset_2")
img_size = 768
num_seeds = 20
